  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="carlos-trigo-fisioterapeuta";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Carlos Trigo Fisioterapeuta Deportivo a Domicilio – Sevilla"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="carlos-trigo-fisioterapeuta"
          data-primary-color="#3a384f"
          defer
        ></script>
      </head>
      <body className="font-sans">
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          (function(){
            ...
            var pid="carlos-trigo-fisioterapeuta";
